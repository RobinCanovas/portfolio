        ...
        {(['All', ...projectFilters] as const).map((tech) => {
          ...
          return (
            <button
              ...
              className={`shrink-0 rounded-full border px-4 py-1.5 font-mono text-xs transition ${
        ...
        <AnimatePresence mode="popLayout">
          {visible.map((p) => (
            <motion.li
              ...
              className="glass group relative flex flex-col overflow-hidden rounded-2xl p-5 transition hover:border-violet-400/40"
            >
