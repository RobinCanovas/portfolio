...
import { Badge, Section, fadeUp } from './ui';
...
export function Education() {
  return (
    <Section id="education" eyebrow="04 · Background" title="Education & Volunteering">
      <div className="grid gap-6 lg:grid-cols-2">
        <motion.div {...fadeUp} className="space-y-6">
          {education.map((ed) => (
            <article key={ed.id} className="glass rounded-2xl p-6">
              <div className="flex items-start gap-4">
                <span className="rounded-xl bg-gradient-to-br from-violet-500 to-cyan-500 p-2.5 text-white">
        ...
        <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.1 }} className="space-y-6">
          <article className="glass relative overflow-hidden rounded-2xl p-6">
            ...
            <div className="flex items-center gap-4">
              <span className="rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 p-2.5 text-white">
